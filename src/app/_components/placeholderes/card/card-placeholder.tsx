...
import {CardPlaceholderProps} from "@/app/_components/placeholderes/card/card-placeholder.type";

export const CardPlaceholder: FC<CardPlaceholderProps> = ({count = 1, className}) => {
